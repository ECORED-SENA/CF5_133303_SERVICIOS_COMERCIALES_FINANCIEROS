  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .tarjeta.color-primario.p-3.mb-5.col-xl-10.mx-auto(style="background: linear-gradient(0deg, rgba(229,240,224,1) 0%, rgba(194,232,176,1) 7%, rgba(229,240,224,1) 100%);" data-aos="fade-left")
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.py-2.justify-content-between.align-items-center
            .col.mb-3.mb-sm-0
              p.mb-0(style="color: black") El siguiente documento #[b(style="color: black") “Tipos principales de métodos de pago”]
                br
