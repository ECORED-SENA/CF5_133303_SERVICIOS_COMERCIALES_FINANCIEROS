  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.mb-5.w-100
      ...
      .card-right-t.p-4.p-xl-5(data-aos="fade-left")
        ...
        p.mb-4 #[b Datos bancarios confiables]
          br
          |El #[em software] de gestión de efectivo debería permitirle extraer varios datos sobre los flujos de efectivo pasados y futuros para facilitar las comunicaciones con el banco y las negociaciones con los socios. 
    ...
    SlyderA.col-xl-10.mx-auto.tarjeta.slide-a-edit.p-3.p-md-4.mb-5(tipo="b" data-aos="fade-left")
      .d-flex.flex-wrap.align-items-center.col-xl-11.mx-auto
        .col-md-6
          figure
            img.mx-auto(src='@/assets/curso/temas/tema6/img-5.png' style="max-width: 400px")
        .col-md-6.mb-4.mb-md-0
          p #[b Documentos de registro de un software]
            br
            br
            |Según el #[em software] que desee registrar, deberá completar y completar el formulario o la solicitud de autorización para adoptar un sistema de contabilidad y sus componentes, libros de cuentas de hojas sueltas. También completar el formulario si desea solicitar un permiso para usar la máquina registradora o la máquina de punto de venta (POS). 

      
      .d-flex.flex-wrap.align-items-center.col-xl-11.mx-auto
        .col-md-6
          figure
            img.mx-auto(src='@/assets/curso/temas/tema6/img-6.png' style="max-width: 400px")
        .col-md-6.mb-4.mb-md-0
          p.fw-bold Perfil de la empresa
          p Se deberán proporcionar detalles de respaldo relacionados con el perfil de la empresa. Estos incluyen:
          ul.lista-ul--color.mb-4(data-aos="fade-left")
            li
              ...
              p.mb-0 Certificado de Registro Único Tributario (RUT).
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Certificado del registro mercantil vigente (Cámara de Comercio).
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Inventario de facturas y recibos no utilizados previamente aprobados, si corresponde una lista de las sucursales de su empresa que utilizarán el #[em software.]
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Requerimientos técnicos.
      .d-flex.flex-wrap.align-items-center.col-xl-11.mx-auto
        .col-md-6
          figure
            img.mx-auto(src='@/assets/curso/temas/tema6/img-7.png' style="max-width: 400px")
        .col-md-6.mb-4.mb-md-0
          p.fw-bold Requisitos técnicos
          ul.lista-ul--color.mb-4(data-aos="fade-left")
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
            ...
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Describir el flujo del sistema del #[em software], el flujo del proceso, el procedimiento de copia de seguridad y el plan de desastres y recuperación.
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Licencia de los equipos de cómputo a instalarse el #[em software.]
      .d-flex.flex-wrap.align-items-center.col-xl-11.mx-auto
        .col-md-6
          figure
            img.mx-auto(src='@/assets/curso/temas/tema6/img-8.png' style="max-width: 400px")
        .col-md-6.mb-4.mb-md-0
          p #[b Requerimientos adicionales]
            br
            br
    ...
    .bloque-texto-g.color-primario.p-3.p-sm-4.p-md-5.col-xl-10.mx-auto.mb-5
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/temas/tema6/img-10.jpg')})`}"
        data-aos="fade-left"
      )
      .bloque-texto-g__texto.p-4(data-aos="fade-right")
        p.mb-0 Hasta que haya registrado formalmente un pago entrante en sus sistemas contables se puede considerar que ese efectivo no existe. Al aplicar un pago a la factura correspondiente, se asegura de que la empresa tenga derecho a esos fondos, por eso es tan importante aplicar los pagos rápidamente. 
          br
          br
    ...
    TabsB.color-acento-contenido.mb-5.tabs-edit(data-aos="fade-left")
      .py-4.py-md-5(titulo="Paso 1" :icono="require('@/assets/curso/temas/tema6/p-1.svg')")
        .row.p-4.p-xl-5
          ...
          p Cuando se recibe el pago de un cliente, por lo general también se recibirá algún tipo de aviso de pago. Esto  permite saber para qué factura(s) es el pago. Los cheques pueden incluir información de envío en la línea de la nota o en un documento adjunto (generalmente justo debajo del cheque).
            br
            br
            |Los pagos electrónicos, sin embargo, son menos sencillos. Con ACH, EFT, transferencias electrónicas y tarjetas virtuales, el aviso de pago llegará por separado en una variedad de formatos posibles.

      .py-4.py-md-5(titulo="Paso 2" :icono="require('@/assets/curso/temas/tema6/p-2.svg')")
        .row.p-4.p-xl-5
          p.fw-bold Hace coincidir el pago con la factura correspondiente
          p Cuando llega un pago con la remesa adjunta, igualar el pago correcto con la factura correcta puede resultar complicado. Por ejemplo, puede recibir un solo pago que cubre varias facturas, en algunos casos más de 40 a 50. También puede encontrar que el monto del pago no coincide exactamente con ningún monto de la factura. Esto suele suceder porque un cliente no ha pagado debido a un descuento o a un problema con el pedido.
            br
            br
            |Recibir el pago sin aviso de ingreso, lidiar con pagos parciales y pagos que cubren múltiples facturas se vuelve aún más desafiante.
      ...
      .d-flex.flex-wrap.align-items-center.mb-5(style="margin-left: -3rem; margin-right: -3rem; min-width: calc(100% + 6rem); background: linear-gradient(180deg, rgba(255,255,255,1) 0%, #FFF9F4 20%, #FFF9F4 80%, rgba(255,255,255,1) 100%)")
        ...
        .col-xl-8.ps-xl-4(data-aos="fade-left")
          ...
          ul.lista-ul--color.mb-4(data-aos="fade-left")
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Compensación de importes de compra para suministros de la empresa y bienes de inventario por adelantado.
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Confirmación de la recepción de los bienes antes de que se emitan los pagos.
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Requerir dos firmas en los cheques de la compañía.
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Aprobar los informes de gastos de los empleados antes de que se reembolse al personal.
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Revisar las hojas de tiempo de los empleados y verificar los cálculos de la nómina.
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
              p.mb-0 Configuración de contraseñas y códigos de identificación para todos los usuarios del sistema de punto de venta.
            li
              .mb-auto.mt-2.me-3(style="height: 11px; min-width: 11px; border-radius: 50%; background-color: #FC8116")
    ...
    .d-flex.flex-wrap.mb-5.w-100(data-aos="fade-left")
      .d-flex.flex-wrap.col-xl-4.px-2.mb-4
        img.mx-auto.p-0.position-relative(src="@/assets/curso/temas/tema6/img-14.svg" style="margin-bottom: -50px; max-width: 94px")
        .tarjeta.w-100(style="background-color: #E5F0E0; padding-top: 45px")
          p.text-center.p-4.mb-0 Proteger las transacciones financieras de la empresa al garantizar que los pagos con tarjeta de débito y crédito sean válidos requiere un esfuerzo de equipo.

      .d-flex.flex-wrap.col-xl-4.px-2.mb-4
        img.mx-auto.p-0.position-relative(src="@/assets/curso/temas/tema6/img-15.svg" style="margin-bottom: -50px; max-width: 94px")
        .tarjeta.w-100(style="background-color: #E5F0E0; padding-top: 45px")
          p.text-center.p-4.mb-0 Los clientes deben presentar su tarjeta de pago (o los detalles de la tarjeta) para la respectiva aprobación y verificar la identidad cuando corresponda.
      
      .d-flex.flex-wrap.col-xl-4.px-2.mb-4
        img.mx-auto.p-0.position-relative(src="@/assets/curso/temas/tema6/img-16.svg" style="margin-bottom: -50px; max-width: 94px")
        .tarjeta.w-100(style="background-color: #E5F0E0; padding-top: 45px")
          p.text-center.p-4.mb-0 El proveedor de cuenta comercial debe obtener la aprobación para el pago del banco del emisor de la tarjeta y comunicar dicha aprobación.
</template>
...
.linea-t-edit
  ...
  .linea-tiempo-d__item--selected .tarjeta
